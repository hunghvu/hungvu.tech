...
- **Unit & Component Testing**: Use **Vitest** (Astro's official recommendation) for testing Astro components, utilities, and isolated TypeScript/JavaScript logic.
- **End-to-End (E2E) Testing**: Use **Playwright** for testing critical user flows, routing integrations, and UI state changes (such as Light/Dark theme toggling).
