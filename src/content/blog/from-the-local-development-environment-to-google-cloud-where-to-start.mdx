...
import image1 from '../../assets/from-the-local-development-environment-to-google-cloud-where-to-start/google-cloud-1.webp';
...
import image2 from '../../assets/from-the-local-development-environment-to-google-cloud-where-to-start/google-cloud-2.webp';
