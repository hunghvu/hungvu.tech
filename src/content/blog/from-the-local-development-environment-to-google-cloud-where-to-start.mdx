...
coverImage: "../../assets/from-the-local-development-environment-to-google-cloud-where-to-start/cover-image.webp"
coverAlt: "My thought process of bring an application from a local to a cloud environment."
publishedDate: "February 04, 2022"
updatedDate: "February 04, 2022"
...
import image1 from "../../assets/from-the-local-development-environment-to-google-cloud-where-to-start/google-computing-stack-as-of-february-2022.webp";

<BlogImage
  imageMetadata={image1}
  alt="Google computing stack as of February 2022."
/>
...
import image2 from "../../assets/from-the-local-development-environment-to-google-cloud-where-to-start/google-relational-databases-platforms-and-use-cases.webp";

<BlogImage
  imageMetadata={image2}
  alt="Google relational databases platforms and use cases."
/>
