...
coverImage: '../../assets/brainstorm-a-deployment-process-from-github-to-google-app-engine-and-cloud-sql-part-2/cover-image.webp'
...
import image1 from '../../assets/brainstorm-a-deployment-process-from-github-to-google-app-engine-and-cloud-sql-part-2/google-cloud-1.webp';
...
import image2 from '../../assets/brainstorm-a-deployment-process-from-github-to-google-app-engine-and-cloud-sql-part-2/google-cloud-2.webp';

<BlogImage imageMetadata={image2} alt='Google Cloud IAM logo.' />
...
import image3 from '../../assets/brainstorm-a-deployment-process-from-github-to-google-app-engine-and-cloud-sql-part-2/google-cloud-3.webp';

<BlogImage imageMetadata={image3} alt='App Engine instance status.' />
...
import image4 from '../../assets/brainstorm-a-deployment-process-from-github-to-google-app-engine-and-cloud-sql-part-2/google-cloud-4.webp';

<BlogImage imageMetadata={image4} alt='GAE application logs.' />
...
import image5 from '../../assets/brainstorm-a-deployment-process-from-github-to-google-app-engine-and-cloud-sql-part-2/heroku-ui-1.webp';

<BlogImage imageMetadata={image5} alt='Heroku environment variables configuration.' />
