...
Please keep in mind the following is about the Customer Service side of CenturyLink (from tier 1 agent to management), not the Field Technicians. Your bad experience is mostly from the Customer Service side. _As a disclaimer, this is only my speculation from the information I have, so treat them with a grain of salt. You can also go to the CenturyLink subreddit to view other customer experiences._
