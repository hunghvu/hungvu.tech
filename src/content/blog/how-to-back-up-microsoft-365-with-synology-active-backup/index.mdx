...
import image1 from "./synology-1.webp";

<BlogPicture
  imageMetadata={image1}
  alt="Install Active Backup for Microsoft 365 from Synology Package Center."
/>
...
import image2 from "./synology-2.webp";
...
import image3 from "./synology-3.webp";

<BlogPicture
  imageMetadata={image3}
  alt="Enable shared folder compression will disable shared folder encryption."
/>
...
import image4 from "./synology-4.webp";

<BlogPicture
  imageMetadata={image4}
  alt="Create a virtual machine backup task."
/>
...
Here is an interesting point, Synology uses **eCryptFS** as an encryption mechanism for its Shared Folder, so there is 143 English characters or 47 Asian (CJK) characters limitation on a file or folder name (_not the whole path length_). Therefore, enabling encryption on a non-encrypted Shared Folder with long-name files will cause an error.

import image5 from "./synology-5.webp";

<BlogPicture
  imageMetadata={image5}
  alt="143 characters limitation of eCryptFS used by Synology."
/>
...
- Choose your preferred **Microsoft 365 Endpoint**. If your subscription is directly from the Microsoft website, then the choice is _Microsoft 365_.
...
import image8 from "./synology-8.webp";

<BlogPicture
  imageMetadata={image8}
  alt="Permission granted to Synology Active Backup for Microsoft 365."
/>
...
import image9 from "./synology-9.webp";

<BlogPicture
  imageMetadata={image9}
  alt="The backup task can be partially failed, but that will not break the setup."
/>
...
import image10 from "./synology-10.webp";

<BlogPicture
  imageMetadata={image10}
  alt="Active Backup for Microsoft 365 is successfully configured."
/>
