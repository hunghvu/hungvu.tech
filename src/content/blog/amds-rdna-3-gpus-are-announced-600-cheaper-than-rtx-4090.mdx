...
At the _together we advance_gaming_ event today, Advanced Micro Devices (AMD) has officially announced the next generation of Radeon 7000 series graphic cards. The two top-of-the-line graphic cards introduced today are the Radeon RX 7900 XTX and Radeon RX 7900 XT, which respectively have an MSRP of $999 for the Radeon RX 7900 XTX and $899 for the latter. Both graphic cards will be available for purchase on December 13.
