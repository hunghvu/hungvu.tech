...
<BlogImage imageMetadata={image1} alt='WordPress.com managed hosting solution as of February 2022.' />
...
<BlogImage imageMetadata={image2} alt='GCP free VPS tier as of February 2022.' />
...
<BlogImage imageMetadata={image3} alt='GCE e2-micro specification as of February 2022.' />
...
<BlogImage imageMetadata={image4} alt='Bitnami and Automattic cross-platform image for WordPress VPS.' />
...
<BlogImage imageMetadata={image5} alt='Cloudflare DNSSEC setup section.' />
...
<BlogImage imageMetadata={image5} alt='HTTP/2 and ALPN Test result.' />
...
<BlogImage imageMetadata={image7} alt='Minor cost incurring in GCP, but negligible.' />
