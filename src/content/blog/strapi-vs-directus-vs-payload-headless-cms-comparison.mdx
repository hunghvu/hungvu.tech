...
import image from '../../assets/blog/20/comparison-1.webp';

<BlogImage imageMetadata={image} alt='Strapi marketplace.' />
...
<BlogImage imageMetadata={image2} alt='Directus Cloud is coming soon.' />
...
<BlogImage imageMetadata={image3} alt='Directus can stay on top of a SQL database.' />
...
<BlogImage imageMetadata={image4} alt='Permission control in Directus.' />
...
<BlogImage imageMetadata={image5} alt='Strapi features can be artificially limited.' />
...
<BlogImage imageMetadata={image6} alt='Directus UI is full of features out of the box.' />
