...
<BlogImage imageMetadata={image1} alt='Choosing Forem-based communities to perform the analysis.' />
...
<BlogImage imageMetadata={image2} alt='Reactions summary by published time.' />

import image3 from '../../assets/blog/12/forem-analytics-3.webp';

<BlogImage imageMetadata={image3} alt='Comments summary by published time.' />
...
<BlogImage imageMetadata={image4} alt='Configuring analysis method using mean, z-score of 3, and minimum of 30 articles.' />

And the results are:

import image5 from '../../assets/blog/12/forem-analytics-5.webp';

<BlogImage imageMetadata={image4} alt='Reactions summary by published time, with adjusted calculation.' />

import image6 from '../../assets/blog/12/forem-analytics-6.webp';

<BlogImage imageMetadata={image6} alt='Comments summary by published time, with adjusted calculation.' />
...
<BlogImage imageMetadata={image7} alt='Reactions summary by reading time.' />

import image8 from '../../assets/blog/12/forem-analytics-8.webp';

<BlogImage imageMetadata={image9} alt='Comments summary by reading time.' />
...
<BlogImage imageMetadata={image9} alt='Reactions summary by reading time, with adjusted calculation.' />

import image10 from '../../assets/blog/12/forem-analytics-10.webp';

<BlogImage imageMetadata={image10} alt='Comments summary by reading time, with adjusted calculation.' />
...
<BlogImage imageMetadata={image11} alt='Reactions summary per tag name, by summation.' />

import image12 from '../../assets/blog/12/forem-analytics-12.webp';

<BlogImage imageMetadata={image12} alt='Comments summary per tag name, by summation.' />
...
<BlogImage imageMetadata={image13} alt='Reactions summary per tag name, by mean.' />

import image14 from '../../assets/blog/12/forem-analytics-13.webp';

<BlogImage imageMetadata={image14} alt='Comments summary per tag name, by mean.' />
