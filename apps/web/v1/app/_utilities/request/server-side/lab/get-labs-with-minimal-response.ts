...
const getLabsWithMinimalResponse = async (): Promise<any> => {
  let res;
  try {
    res = await fetch(
      process.env.NEXT_REQUEST_CMS_LABS_IGNORE_REDUNDANT_FIELDS_URL!,
...
export default getLabsWithMinimalResponse;