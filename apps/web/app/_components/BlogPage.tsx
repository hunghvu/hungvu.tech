        ...
        <Card title={<h2>{item.title}</h2>}
          ...
          footer={
            <Button
              ...
              pt={{
                root: { className: `p-0 ${geist.className}` }
              }}
      ...
      <aside className="flex flex-col items-end gap-2">
        ...
        {item.tags.map((tag: string) => <Tag key={tag} value={tag}
          ...
          pt={{
            ...
            value: { className: `text-xs md:text-sm lg:text-base ${geist.className}` }
          }}></Tag>)}
      </aside>
    )
  }
    ...
    <section className="flex flex-row">
      <ScrollPanel pt={{
        ...
        <Timeline value={data} opposite={customizedOpposite} content={customizedContent} pt={{
          ...
          opposite: {
            className: "flex grow-0 text-sm md:text-base lg:text-lg",
          },
          content: {
            className: "flex grow",
          }
