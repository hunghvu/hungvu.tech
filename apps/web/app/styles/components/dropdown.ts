...
const dropdown: DropdownPassThroughOptions = {
  root: ({ props }: DropdownPassThroughMethodOptions) => ({
    className: `
        ...
        bg-zinc-100 border border-gray-400 transition-colors duration-200 ease-in-out rounded-md
        w-full md:w-56
  ...
  input: ({ props }: DropdownPassThroughMethodOptions) => ({
    className: `
        ...
        border-0 p-3 transition duration-200 rounded appearance-none font-sans text-base
  ...
  item: ({ context }: DropdownPassThroughMethodOptions) => ({
    className: `
        ...
        m-0 p-3 border-0  transition-shadow duration-200 rounded-none text-black text-lg
